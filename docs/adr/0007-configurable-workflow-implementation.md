# ADR 0007: Configurable Workflow Implementation
...
Use repo-owned configurable workflow definitions for research platform workflows, integrated with Django, Viewflow, Celery, and durable run artifacts.
