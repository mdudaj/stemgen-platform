# ADR 0009: WhatsApp Evaluator Channel
...
Add WhatsApp as an optional secondary evaluator communication channel while keeping the web platform as the canonical evaluation interface.
